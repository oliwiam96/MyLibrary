    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            if (user != null)
            {
                ...
                {
                    string callbackUrl = await SendEmailConfirmationTokenAsync(user.Id, "Potwierdzenie adresu email- ponowna próba.");
                    // Uncomment to debug locally  
                    // ViewBag.Link = callbackUrl
                    ViewBag.errorMessage = "Musisz mieć potwierdzony email, żeby się zalogować.";
                    return View("Error");
                }
            }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    ViewBag.Message = "Zanim będziesz mógł się zalogować, musisz mieć potwierdzone konto. " +
                        "Sprawdź swój e-mail i potwierdź konto, klikając w nadesłany link.";
